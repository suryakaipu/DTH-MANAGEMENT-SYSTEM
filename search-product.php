...
<li class="breadcrumb-item active" aria-current="page">Channel</li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Search Channel</h4>
                </div>
                <!-- /Title -->
...
<input type="text" class="form-control" id="validationCustom03" placeholder="Channel Name" name="productname" required>
