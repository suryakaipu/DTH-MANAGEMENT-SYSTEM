...
$catname=$_POST['id']; 
$company=$_POST['name'];   
$pname=$_POST['mobilenumber'];
$pprice=$_POST['address'];
$query=mysqli_query($con,"insert into tblcustomer(id,name,mobilenumber,address) values('$catname','$company','$pname','$pprice')"); 
if($query){
...
<input type="text" class="form-control" id="validationCustom03" placeholder="Name" name="mobilenumber" required>
