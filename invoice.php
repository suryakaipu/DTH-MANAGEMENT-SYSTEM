...
<div class="hk-pg-header">
 <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="file"></i></span></span>View Payment</h4>
                </div>
                <!-- /Title -->
...
<h3 class="mb-35 font-weight-600">     DTH </h3>
<h6 class="mb-5"> UrDTH </h6>
</div>
